...
**Tóm tắt mã nguồn — StudentAnalyzer (Tiếng Việt, ngắn gọn)**
...
Ghi chú ngắn: README này chỉ tóm tắt chức năng mã nguồn; phần hướng dẫn chạy đã được loại bỏ theo yêu cầu.
